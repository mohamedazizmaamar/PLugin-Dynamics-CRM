...
/// <summary>
/// <para>Ligne dans une commande client.</para>
/// <para>Display Name: Produit de la commande</para>
/// </summary>
...
public partial class SalesOrderDetail : ExtendedEntity<EmptyEnum, EmptyEnum> {
    ...
    /// <summary>
    /// <para>Identificateur unique du produit spécifié dans la commande.</para>
    /// <para>Display Name: Produit de la commande</para>
    /// </summary>
    [AttributeLogicalName("salesorderdetailid")]
    [DisplayName("Produit de la commande")]
    ...
    /// <summary>
    /// <para>Affiche le prix total du produit de la commande, basé sur le prix unitaire, la remise sur quantité et la quantité.</para>
    ...
    /// <summary>
    /// <para>Entrez des informations supplémentaires pour décrire le produit de la commande, par exemple les informations de fabrication ou les substitutions acceptables.</para>
    ...
    /// <summary>
    /// <para>Affiche le montant total dû pour le produit de la commande, égal à la somme du prix unitaire, de la quantité, des remises et des taxes.</para>
    ...
    /// <summary>
    /// <para>Indiquez si la ligne de facture a été copiée à partir d'un autre élément ou d'une autre source de données.</para>
    ...
    /// <summary>
    /// <para>Indiquez si le prix unitaire est fixé à la valeur indiquée dans les tarifs spécifiés ou s’il peut être remplacé par les utilisateurs qui ont les droits de modification du produit de la commande.</para>
    ...
    /// <summary>
    /// <para>Indiquez si le produit existe dans le catalogue de produits Microsoft Dynamics 365 ou s'il s'agit d'un produit hors catalogue spécifique à la commande.</para>
    ...
    /// <summary>
    /// <para>Tapez le numéro de ligne du produit de la commande pour identifier simplement le produit sur la commande et garantir son classement dans l'ordre approprié.</para>
    ...
    /// <summary>
    /// <para>Tapez le montant de la remise manuelle du produit de la commande pour déduire les remises négociées ou autres du total du produit sur la commande.</para>
    ...
    /// <para>Display Name: Remise (de base)</para>
    /// </summary>
    [AttributeLogicalName("manualdiscountamount_base")]
    [DisplayName("Remise (de base)")]
    ...
    /// <summary>
    /// <para>Tapez le prix unitaire du produit de la commande. La valeur par défaut est celle des tarifs spécifiés sur la commande pour les produits existants.</para>
    ...
    /// <summary>
    /// <para>Nom des détails de la commande client. Ajouté pour la relation référentielle 1 à n (utilisation interne uniquement)</para>
    ...
    /// <summary>
    /// <para>Identificateur unique de l'association de ligne de produit avec l'offre groupée dans la commande client</para>
    ...
    /// <summary>
    /// <para>Tapez un nom ou une description pour identifier le type de produit hors catalogue inclus à la commande.</para>
    ...
    /// <summary>
    /// <para>Choisissez le produit à inclure dans la commande pour lier la tarification du produit et d'autres informations à la commande parente.</para>
    ...
    /// <summary>
    /// <para>Tapez le montant ou la quantité du produit commandé par le client.</para>
    ...
    /// <summary>
    /// <para>Tapez le montant ou la quantité du produit dont la livraison est différée pour la commande.</para>
    ...
    /// <summary>
    /// <para>Tapez le montant ou la quantité du produit qui a été annulé.</para>
    ...
    /// <summary>
    /// <para>Tapez le montant ou la quantité du produit qui a été livré pour la commande.</para>
    ...
    /// <summary>
    /// <para>Identificateur unique de la ligne de devis associée à la ligne de commande.</para>
    /// <para>Display Name: ID du produit du devis</para>
    /// </summary>
    [AttributeLogicalName("quotedetailid")]
    [DisplayName("ID du produit du devis")]
    ...
    /// <summary>
    /// <para>Entrez la date de livraison demandée par le client pour le produit de la commande.</para>
    ...
    /// <summary>
    /// <para>Affiche la commande pour le produit. La référence permet de lier la tarification du produit et d'autres informations au montants totaux et à d'autres informations sur la commande.</para>
    ...
    /// <summary>
    /// <para>Indique si les tarifs sont verrouillés pour la commande.</para>
    /// <para>Display Name: Commande avec prix bloqué</para>
    /// </summary>
    [AttributeLogicalName("salesorderispricelocked")]
    [DisplayName("Commande avec prix bloqué")]
    ...
    /// <summary>
    /// <para>Affiche le statut de la commande à laquelle les informations de commande sont associées.</para>
    /// <para>Display Name: Statut de la commande</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>Choisissez l'utilisateur responsable de la vente du produit de la commande.</para>
    ...
    /// <summary>
    /// <para>Tapez le montant des taxes pour le produit de la commande.</para>
    ...
    /// <summary>
    /// <para>Indiquez si le produit de la commande doit être livré à l'adresse spécifiée ou conservé jusqu'à ce que le client donne des instructions d'enlèvement ou de livraison.</para>
    ...
    public QuoteDetail msdyn_quotedetail_salesorderdetail {
        get {
            return GetRelatedEntity<QuoteDetail>("msdyn_quotedetail_salesorderdetail", null);
        }
        set {
            SetRelatedEntity("msdyn_quotedetail_salesorderdetail", null, value);
        }
    }
    
    [RelationshipSchemaName("msdyn_salesorderdetail_invoicedetail")]
    public IEnumerable<InvoiceDetail> msdyn_salesorderdetail_invoicedetail {
        get {
            return GetRelatedEntities<InvoiceDetail>("msdyn_salesorderdetail_invoicedetail", null);
        }
        set {
            SetRelatedEntities("msdyn_salesorderdetail_invoicedetail", null, value);
        }
    }
    
    [AttributeLogicalName("nxt_vatcodeid")]
    [RelationshipSchemaName("nxt_salesorderdetail_VatCodeId_nxt_vat")]
    public nxt_Vat nxt_salesorderdetail_VatCodeId_nxt_vat {
        get {
            return GetRelatedEntity<nxt_Vat>("nxt_salesorderdetail_VatCodeId_nxt_vat", null);
        }
        set {
            SetRelatedEntity("nxt_salesorderdetail_VatCodeId_nxt_vat", null, value);
        }
    }
